...
export default async function handler(request, response) {
  ...
  try {
    // Ensure table exists (oyun adina gore shader cache DIZIN yollari; cache dosyalari degil)
    await sql`
    ...
    if (request.method === 'GET') {
      ...
      // Ayni oyun adi varsa guncelle (upsert mantigi), yoksa ekle
    ...
    console.error("Shader Archive API Error:", error);
